        ...
        <div className="hidden lg:block space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Professional University Network</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Connect with students, faculty, and alumni. Stay updated with campus events and opportunities.
            </p>
          </div>

          <div className="space-y-3">
            {[
              "Connect with 10,000+ UIU members",
